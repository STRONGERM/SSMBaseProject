...
<link rel="stylesheet" media="screen"
	href="../res/admin/login/css/style.css">
<link rel="stylesheet" type="text/css"
	href="../res/admin/login/css/reset.css">
<body>
		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img">
					<img src="../res/admin/login/images/name.png">
				</div>
			...
			<div class="login-center clearfix">
				<div class="login-center-img">
					<img src="../res/admin/login/images/password.png">
				</div>
				<div class="login-center-input">
			...
			<div class="login-center clearfix">
				<div class="login-center-img">
					<img src="../res/admin/login/images/yzm.png">
				</div>
				<div class="login-center-input">
	...
	<!-- scripts -->
	<script src="../res/admin/login/js/particles.min.js"></script>
	<script src="../res/admin/login/js/app.js"></script>
	<script src="../res/admin/login/js/jquery-1.8.0.min.js"></script>
